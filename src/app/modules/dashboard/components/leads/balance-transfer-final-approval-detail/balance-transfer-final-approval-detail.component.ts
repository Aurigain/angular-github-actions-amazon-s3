...
@Component({
  selector: 'app-balance-transfer-final-approval-detail',
  templateUrl: './balance-transfer-final-approval-detail.component.html',
  styleUrls: ['./balance-transfer-final-approval-detail.component.scss']
})
export class BalanceTransferFinalApprovalDetailComponent implements OnInit {
