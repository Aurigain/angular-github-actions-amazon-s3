...
@Component({
  ...
  templateUrl: './balance-transfer-approval-list.component.html',
  styleUrls: ['./balance-transfer-approval-list.component.scss']
})
export class BalanceTransferApprovalListComponent implements OnInit {
  rowFilter: number = 1;
