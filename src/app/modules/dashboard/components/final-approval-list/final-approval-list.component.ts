...
@Component({
  ...
  templateUrl: './final-approval-list.component.html',
  styleUrls: ['./final-approval-list.component.scss']
})
export class FinalApprovalListComponent implements OnInit {
  rowFilter: number = 1;
  ...
  fetchAllBTLeads() {
    this.misc.FetchAllLoanRequests().subscribe(
      data => {
        this.allBTLeadsList = data['results'];
        console.log("list ", this.allBTLeadsList)
      }
    )
  }
